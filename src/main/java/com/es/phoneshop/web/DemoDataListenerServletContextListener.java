...
public class DemoDataListenerServletContextListener implements ServletContextListener {
    ...
    private void saveSampleProducts() throws ProductNotFoundException {
        ...
        priceHistories.add(new PriceHistory(new BigDecimal(120), new Date(2001, Calendar.NOVEMBER, 5)));
        priceHistories.add(new PriceHistory(new BigDecimal(123), new Date(2005, Calendar.AUGUST,7)));
        priceHistories.add(new PriceHistory(new BigDecimal(4124), new Date()));
